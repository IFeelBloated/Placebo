ECHO RawReader ("B.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () > TMP.avs
...
ECHO Y=RawReader("B.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () > TMP.avs
...
call ffmpeg -i TMP.avs -c:v rawvideo MblurB.rgb
del TMP.avs
del Minblur.rgb
del SuperR.rgb
...
ECHO Mblur=RawReader ("MblurB.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () >> TMP.avs
ECHO Dec=RawReader ("Mblur.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () >> TMP.avs
ECHO HaloCancelation16 (Retouch, Y, Mblur, Dec) >> TMP.avs
call ffmpeg -i TMP.avs -c:v rawvideo FinalB.rgb
del TMP.avs
del Retouched.rgb
del MblurB.rgb
