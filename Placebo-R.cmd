ECHO RawReader ("R.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () > TMP.avs
...
ECHO Y=RawReader("R.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () > TMP.avs
...
call ffmpeg -i TMP.avs -c:v rawvideo MblurR.rgb
del TMP.avs
del Minblur.rgb
del SuperR.rgb
...
ECHO Mblur=RawReader ("MblurR.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () >> TMP.avs
...
call ffmpeg -i TMP.avs -c:v rawvideo FinalR.rgb
del TMP.avs
del Retouched.rgb
del MblurR.rgb
