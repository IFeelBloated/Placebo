ECHO RawReader ("G.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () > TMP.avs
...
ECHO Y=RawReader("G.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () > TMP.avs
...
call ffmpeg -i TMP.avs -c:v rawvideo MblurG.rgb
del TMP.avs
del Minblur.rgb
del SuperR.rgb
...
ECHO Mblur=RawReader ("MblurG.rgb", "Y8", 736, 960, packing="8:0:8").ConvertToY8 () >> TMP.avs
...
call ffmpeg -i TMP.avs -c:v rawvideo FinalG.rgb
del TMP.avs
del Retouched.rgb
del MblurG.rgb
