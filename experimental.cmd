...
ECHO GetVectors (supersearch=supersearch, tr=6, pel=4, dct=1, thsad=400, vccs="yv16", tv_range=False) >> temp.avs
...
ECHO GenSuperclip16 (pel=4, curve="srgb", tv_range=False) >> temp.avs
ECHO YTo420_16() >> temp.avs
call x264.exe --output superm.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
del /f /s /q *.lwi

ECHO LWLibAVVideoSource ("sharprRGB.mp4") > temp.avs
ECHO converttoy8 () >> temp.avs
ECHO GenSuperclip16 (pel=4, curve="srgb", tv_range=False) >> temp.avs
ECHO YTo420_16() >> temp.avs
call x264.exe --output supermRGB.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
del /f /s /q *.lwi

ECHO LWLibAVVideoSource("sharpr.mp4") > temp.avs
ECHO blur=MinBlur16(radius=1) >> temp.avs
ECHO superclip=LWLibAVVideoSource("superm.mp4") >> temp.avs
ECHO vclip=LWLibAVVideoSource("vmultit.mp4") >> temp.avs
ECHO MBlur16(blur=blur, superclip=superclip, vclip=vclip, pel=4, tr=6, thsad=400, repmode=1, repmodeu=1, repmodev=1, tv_range=False) >> temp.avs
call x264.exe --output minblur.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
del superm.mp4
del /f /s /q *.lwi

ECHO LWLibAVVideoSource("sharprRGB.mp4").selectevery (3,0) > temp.avs
ECHO blur=MinBlur16(radius=1) >> temp.avs
ECHO superclip=LWLibAVVideoSource("supermRGB.mp4").selectevery (3,0) >> temp.avs
ECHO vclip=LWLibAVVideoSource("vmultit.mp4") >> temp.avs
ECHO MBlur16(blur=blur, superclip=superclip, vclip=vclip, pel=4, tr=6, thsad=400, repmode=1, repmodeu=1, repmodev=1, tv_range=False) >> temp.avs
call x264.exe --output R.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
...
ECHO LWLibAVVideoSource("sharprRGB.mp4").selectevery (3,1) > temp.avs
ECHO blur=MinBlur16(radius=1) >> temp.avs
ECHO superclip=LWLibAVVideoSource("supermRGB.mp4").selectevery (3,1) >> temp.avs
ECHO vclip=LWLibAVVideoSource("vmultit.mp4") >> temp.avs
ECHO MBlur16(blur=blur, superclip=superclip, vclip=vclip, pel=4, tr=6, thsad=400, repmode=1, repmodeu=1, repmodev=1, tv_range=False) >> temp.avs
call x264.exe --output G.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
...
ECHO LWLibAVVideoSource("sharprRGB.mp4").selectevery (3,2) > temp.avs
ECHO blur=MinBlur16(radius=1) >> temp.avs
ECHO superclip=LWLibAVVideoSource("supermRGB.mp4").selectevery (3,2) >> temp.avs
ECHO vclip=LWLibAVVideoSource("vmultit.mp4") >> temp.avs
ECHO MBlur16(blur=blur, superclip=superclip, vclip=vclip, pel=4, tr=6, thsad=400, repmode=1, repmodeu=1, repmodev=1, tv_range=False) >> temp.avs
call x264.exe --output B.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
...
ECHO b=LWLibAVVideoSource ("B.mp4") >> temp.avs
ECHO Interleave (r, g, b) >> temp.avs
call x264.exe --output minblurRGB.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
del R.mp4
del G.mp4
del B.mp4
...
ECHO LWLibAVVideoSource("sharpr.mp4") > temp.avs
ECHO source=LWLibAVVideoSource("search.mp4") >> temp.avs
ECHO minblur=LWLibAVVideoSource("minblur.mp4") >> temp.avs
ECHO detect=LWLibAVVideoSource("minblur.mp4") >> temp.avs
ECHO HaloCancelation16(source=source, minblur=minblur, detect=detect, a1=16, a2=96, a3=128, radius=4, mthr=60, tv_range=False) >> temp.avs
...
ECHO LWLibAVVideoSource("sharprRGB.mp4") > temp.avs
ECHO source=LWLibAVVideoSource("search.mp4") >> temp.avs
ECHO minblur=LWLibAVVideoSource("minblurRGB.mp4") >> temp.avs
ECHO detect=LWLibAVVideoSource("minblur.mp4") >> temp.avs
ECHO HaloCancelation16(source=Interleave (source, source, source), minblur=minblur, detect=Interleave (detect, detect, detect), a1=16, a2=96, a3=128, radius=4, mthr=60, tv_range=False) >> temp.avs
call x264.exe --output sharpRGB.mp4 --preset ultrafast --qp 0 temp.avs
del temp.avs
del sharprRGB.mp4
del minblur.mp4
del minblurRGB.mp4
